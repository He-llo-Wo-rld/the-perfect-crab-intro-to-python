...
def remove_item_from_list(the_list: list, item: any) -> list:
...
def count_items_in_list(the_list: list, item: any) -> int:
    if not isinstance(the_list, list):
        raise TypeError(f"Invalid type {type(the_list).__name__}, must be list")
...
def get_index_of_item(the_list: list, item: any) -> int:
    if not isinstance(the_list, list):
        raise TypeError(f"Invalid type {type(the_list).__name__}, must be list")
...
def list_length(the_list: list) -> int:
    if not isinstance(the_list, list):
        raise TypeError(f"Invalid type {type(the_list).__name__}, must be list")
    return len(the_list)
